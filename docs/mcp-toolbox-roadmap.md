...
| OpenFOAM | run case commands | `log.*`, mesh checks, VTK/foam files |
| ParaView | run pvpython postprocessing | screenshots, state files, CSV |
...
See [`deep-solver-bridge-mcp.md`](deep-solver-bridge-mcp.md) for the current
deep bridge design.
