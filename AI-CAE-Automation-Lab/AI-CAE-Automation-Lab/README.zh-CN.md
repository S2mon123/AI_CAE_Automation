...
| `ansys_check_installation` | 检查 Ansys/Fluent/Workbench 配置路径，不启动软件 |
| `ansys_run_workbench_journal_file` | 批处理运行 Workbench journal 并写入日志 |
| `comsol_check_installation` | 检查 COMSOL batch、Java 和 API 文档路径 |
| `comsol_run_batch_file` | 运行 COMSOL batch 命令并写入日志 |
| `pcschematic_check_installation` | 检查 PCSCHEMATIC 路径配置，不启动软件 |

Abaqus、Ansys Fluent、Ansys Workbench、COMSOL、PCSCHEMATIC 已有最小适配器；MATLAB/Simulink、OpenFOAM、ParaView 会继续扩展。
...
7. [`docs/local-mcp-source-audit.md`](docs/local-mcp-source-audit.md)
8. [`docs/electrical-cad-automation.md`](docs/electrical-cad-automation.md)
9. [`checklists/smoke-test.md`](checklists/smoke-test.md)
10. [`prompts/ai-cae-general.md`](prompts/ai-cae-general.md)
11. [`prompts/pcschematic-direct-motor-starter.md`](prompts/pcschematic-direct-motor-starter.md)
